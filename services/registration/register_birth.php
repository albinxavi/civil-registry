<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      move_uploaded_file($_FILES['birth_proof']['tmp_name'],$target_dir.$name);
      $sql = "INSERT into birth_reg (user_id, dob, child_name, child_sex, place_of_birth, birth_weight, mother_name, mother_age, father_name, father_age, birth_housename, birth_city, birth_district, birth_state, delivery_method) VALUES ('$user_id', '$dob', '$child_name', '$child_sex', '$place_of_birth', '$birth_weight', '$mother_name', '$mother_age', '$father_name', '$father_age', '$birth_housename', '$birth_city', '$birth_district', '$birth_state', '$delivery_method')";
